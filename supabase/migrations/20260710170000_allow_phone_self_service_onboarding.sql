-- Allows self-service EPC workspace creation after either email confirmation
-- or SMS phone verification. Phone-auth users keep their verified Auth phone
-- as the tenant admin phone so an unverified replacement cannot be supplied.
