...
values
  ...
  ('invoices', 'Tax Invoices', 'Invoice creation and tracking', 70, true),
  ...
  ('purchases', 'Purchase Orders', 'Purchase records and approvals', 110, true),
  ('vendors', 'Suppliers', 'Vendor management', 120, true),
