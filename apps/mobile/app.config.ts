...
export default (): ExpoConfig => ({
  ...
  slug: "bizlee-mobile", scheme: "bizlee", version: "0.1.0", orientation: "portrait", userInterfaceStyle: "automatic",
  ios: { supportsTablet: true, bundleIdentifier: `com.bizlee.mobile${suffix}`, associatedDomains: ["applinks:app.getbizlee.com"] },
  android: { package: `com.bizlee.mobile${suffix}`, adaptiveIcon: { backgroundColor: "#06173f" }, intentFilters: [{ action: "VIEW", autoVerify: true, data: [{ scheme: "https", host: "app.getbizlee.com", pathPrefix: "/mobile" }], category: ["BROWSABLE", "DEFAULT"] }] },
  plugins: ["expo-router", "expo-secure-store", ["expo-notifications", { color: "#f97316" }]],
