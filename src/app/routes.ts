...
export const routes: AppRoute[] = [
  ...
  },
  {
    ...
    moduleKey: "platform_staff",
    description: "Super-admin management for role-based platform staff.",
    superAdminOnly: true,
  },
  {
    path: "/dashboard",
  ...
  },
  {
    ...
    label: "Sales Orders",
    moduleKey: "b2b_sales",
    description: "Project-free product and bulk sales to business customers.",
  },
  {
